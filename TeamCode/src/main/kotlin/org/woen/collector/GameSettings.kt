...
internal object GAME_CONFIGS {
    ...
    @JvmField
    var START_RED_FAR_ORIENTATION = Orientation(Vec2(0.01 + 1.35 + 0.38 / 2.0, 0.225 + 0.38 / 2.0 + 0.01), Angle.ofDeg(0.0))
...
enum class StartOrientation(
    ...
    RED_CLOSE(
        GAME_CONFIGS.START_RED_CLOSE_ORIENTATION, { GAME_CONFIGS.RED_BASKET_POSITION }, { GAME_CONFIGS.RED_FAR_BASKET_POSITION},
        GAME_CONFIGS.RED_PARKING_ORIENTATION, GameColor.RED, GamePosition.CLOSE
    ),
    RED_FAR(
        GAME_CONFIGS.START_RED_FAR_ORIENTATION, { GAME_CONFIGS.RED_BASKET_POSITION }, { GAME_CONFIGS.RED_FAR_BASKET_POSITION},
        GAME_CONFIGS.RED_PARKING_ORIENTATION, GameColor.RED, GamePosition.FAR
    ),
    BLUE_CLOSE(
        GAME_CONFIGS.START_BLUE_CLOSE_ORIENTATION, { GAME_CONFIGS.BLUE_BASKET_POSITION }, { GAME_CONFIGS.BLUE_FAR_BASKET_POSITION},
        GAME_CONFIGS.BLUE_PARKING_ORIENTATION, GameColor.BLUE, GamePosition.CLOSE
    ),
    BLUE_FAR(
        GAME_CONFIGS.START_BLUE_FAR_ORIENTATION, { GAME_CONFIGS.BLUE_BASKET_POSITION }, { GAME_CONFIGS.BLUE_FAR_BASKET_POSITION},
