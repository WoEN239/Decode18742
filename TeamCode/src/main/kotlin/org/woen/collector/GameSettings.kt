...
internal object GAME_CONFIGS {
    ...
    @JvmField
    var BLUE_BASKET_POSITION = Vec2(-1.78, -1.7)

    @JvmField
    var RED_BASKET_POSITION = Vec2(-1.78, 1.7)

    @JvmField
    var BLUE_FAR_BASKET_POSITION = Vec2(-1.67, -1.7)

    @JvmField
    var RED_FAR_BASKET_POSITION = Vec2(-1.67, 1.7)
