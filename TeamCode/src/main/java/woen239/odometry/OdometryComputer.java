...
public class OdometryComputer extends I2cDeviceSynchDevice<I2cDeviceSynchSimple> {
    ...
    public OdometryComputer(I2cDeviceSynchSimple deviceClient, boolean deviceClientIsOwned) {
